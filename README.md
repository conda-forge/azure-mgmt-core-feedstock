...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/azure-mgmt-core-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=11218&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/azure-mgmt-core-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `azure-mgmt-core` can be installed with:

```
conda install azure-mgmt-core
```

It is possible to list all of the versions of `azure-mgmt-core` available on your platform with:
